...
var tok="24.22710e1c1dd3e5e211cc9e6ec13cd77d.2592000.1565531006.282335-8834670";
function sy(id){
if(id==0){
...
return "http://tsn.baidu.com/text2audio?tok="+tok+"&tex="+text+"&cuid=baidu_speech_demo&lan=zh&spd="+spd+"&per="+per+"&vol="+vol+"&pit="+pit+"&ctp=1";
}
//暂停或播放
function p(id){
